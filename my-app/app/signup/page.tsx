...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(`Account created. Your referral code: ${user.referralCode}`);
      navigate.push("/");
    } catch (err) {
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <input
                  ...
                  onChange={handleChange}
                  className="block w-full px-3 py-2 border border-gray-300 rounded-md uppercase focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  placeholder="CARS24-ABC123"
                />
              </div>
            </div>
